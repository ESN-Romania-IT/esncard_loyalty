    ...
    <div class="min-h-screen bg-gray-50 py-8 px-4">
        <div class="max-w-7xl mx-auto bg-white shadow-md p-6 rounded-3xl border border-gray-200">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h2 class="text-2xl font-bold text-[#2e3192]">Clients</h2>
                    <p class="text-sm text-gray-600">Browse and inspect client profiles</p>
                </div>
                    ...
                    <tbody>
                        @forelse($clients as $client)
                            <tr class="border-t">
                                ...
                                <td class="p-3 border-b font-medium text-gray-800">{{ $client->first_name }}
                                    {{ $client->last_name }}</td>
                                <td class="p-3 border-b">{{ $client->user?->email }}</td>
