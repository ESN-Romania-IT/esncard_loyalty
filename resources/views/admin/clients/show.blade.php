<x-app-layout>
    ...
    >
                ...
                <form method="POST" action="{{ route('admin.clients.redemptions.store', $client) }}">
                    ...
                    <select x-model="offerId"
                        ...
                        <template x-for="o in offersForBusiness()" :key="o.id">
                            <option :value="o.id" x-text="o.title + ' (max ' + o.uses_per_client + ')'"></option>
                        </template>
                    </select>
                    ...
                    <input type="number"
                        ...
                        min="1"
                        :max="remainingUses()"
                        :disabled="!offerId || remainingUses() === 0"
                        @blur="normalizeQty()"
                        class="w-full border p-2 rounded mb-4">
        ...
        <div x-show="removeOpen" x-cloak style="display:none;" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
