<x-app-layout>
    <div class="max-w-md mx-auto mt-10 bg-white shadow-md p-6 rounded">
        <h2 class="text-xl font-bold mb-2">Business Dashboard</h2>
        <p class="mb-4">You are logged in as a <b>BUSINESS USER</b>.</p>

        <div class="text-sm bg-gray-100 p-3 rounded mb-6">
        ...
        <div class="bg-white shadow-md p-6 rounded">
            <h2 class="text-xl font-bold mb-4 text-center">QR Scanner</h2>

            <div class="flex justify-center gap-3 mb-4">
                <button id="btn-start" type="button" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                    Start
                </button>
            ...
            {{-- Result --}}
            <div id="rezultat-scanare" class="mt-4 font-bold text-green-600 text-center"></div>

            <div id="scan-result-card" class="mt-4 hidden border border-green-200 bg-green-50 p-4 rounded">
                ...
                <div id="offers-panel" class="mt-4 hidden border border-emerald-200 bg-white p-4 rounded">
                    <div class="flex items-center justify-between mb-3">
                        <div class="text-sm font-semibold text-gray-700">Available offers</div>
                    </div>

                    <div id="offers-notice" class="mb-3 text-sm text-emerald-700 hidden"></div>
            ...
            @else
                <div class="space-y-3">
                    @foreach ($activeOffers as $offer)
                        <div class="border border-gray-200 rounded p-4 flex items-center justify-between gap-4">
                            <div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                async function loadOffers(clientId) {
                    ...
                    offers.forEach((offer) => {
                        ...
                        row.className = 'border border-gray-200 rounded p-3';
                        ...
                        usage.className = 'text-xs text-gray-500';
                        ...
                        minusBtn.className =
                            'w-10 h-10 text-xl rounded bg-gray-200 text-gray-700 hover:bg-gray-300';

                        const qtyInput = document.createElement('input');
                        qtyInput.type = 'text';
                        qtyInput.readOnly = true;
                        qtyInput.value = '1';
                        qtyInput.className = 'w-14 h-10 text-center border rounded text-base';
                        ...
                        redeemBtn.className =
                            'bg-blue-600 text-white px-4 py-2 rounded text-sm hover:bg-blue-700';
